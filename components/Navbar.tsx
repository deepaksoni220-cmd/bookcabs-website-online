  ...
  return (
    <header style={{
      ...
      <nav style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <NavLink href="/" label="Airport - Melbourne" active={path === '/'} />
        <NavLink href="/cars-fleet" label="Our car fleets" active={path === '/cars-fleet'} />
      ...
      {menuOpen && (
        <div style={{
          ...
          <MobileNavLink href="/" label="Airport - Melbourne" onClick={() => setMenuOpen(false)} />
          <MobileNavLink href="/cars-fleet" label="Our car fleets" onClick={() => setMenuOpen(false)} />
        </div>
      )}
    </header>
  );
