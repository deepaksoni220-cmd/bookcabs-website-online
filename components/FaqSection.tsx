    ...
    >
      ...
      <div
        style={{
          ...
          width: '500px',
          height: '500px',
          background: 'radial-gradient(circle, rgba(56,189,248,0.08) 0%, rgba(9,13,20,0) 70%)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
        ...
        <div className="Faq_GridContainer">
          ...
          <div className="Faq_StickyLeftCol">
            <div className="Faq_StickyInner">
              ...
              >
                Got Questions?<br />
                <span style={{ color: '#38BDF8', fontStyle: 'italic' }}>We've Got Answers.</span>
              </h2>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '14px' }}>
                  ...
                  <div>
                    ...
                    <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px' }}>VIP Concierge Support</span>
                  </div>
                </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isOpen
                        ? '0 12px 30px rgba(0, 0, 0, 0.6), 0 0 18px rgba(56, 189, 248, 0.2)'
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '18px' }}>
                        <span
                          style={{
                            ...
                            fontSize: '13px',
                            fontWeight: 700,
                            color: isOpen ? '#38BDF8' : 'rgba(255,255,255,0.3)',
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: '50%',
                          background: isOpen
                            ? 'linear-gradient(135deg, #38BDF8 0%, #0F63BD 100%)'
