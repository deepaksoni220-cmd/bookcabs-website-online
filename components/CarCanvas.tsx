...
export default function CarCanvas({
  ...
  return (
    ...
    >
      ...
      {/* Crisp Light Blue Glow from Podium Rim */}
      <pointLight position={[0, -0.6, 0]} intensity={7.5} color="#38BDF8" distance={12} />
      <pointLight position={[2, -0.4, 2]} intensity={4.0} color="#60A5FA" distance={8} />
      <pointLight position={[-2, -0.4, -2]} intensity={4.0} color="#60A5FA" distance={8} />
